...
<?php
    ...
    $conf_subject = "$rp_name Conference";

    $conf_extra = "From: ACM Conference <conference@acm.uiuc.edu>\r\n";

    $conf_email = "Thank you for indicating your interest in the $rp_name $rp_year Computing Conference on $rp_date.

To provide your resume (in an electronic format) to the job fair recruiters, click here:
http://www.acm.uiuc.edu/conference/$rp_year/resume.php?e=" . urlencode($_REQUEST[email]) . "
...
To provide your resume (in an electronic format) to the job fair recruiters, click here:
http://www.acm.uiuc.edu/conference/$rp_year/resume.php?e=$_REQUEST[email]
